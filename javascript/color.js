...
let colorList=[null,'#609F60','#EEEE00','#FFB3FF','#C0C0C0','#22DDB8','#FFCCCC','#008888','#BF9FDF','#B7879F','#FF9F40','#ff6347','#f5deb3','#191970','#e6e6fa','#EEEE00','#FFB3FF','#C0C0C0','#22DDB8','#FFCCCC','#008888','#BF9FDF','#B7879F','#FF9F40','#ff6347','#f5deb3','#191970','#e6e6fa','#EEEE00','#FFB3FF','#C0C0C0','#22DDB8'];
//background color list
let backgroundColorIndex = 0;
let backgroundColor=['rgb(78, 133, 78)','rgb(228, 240, 66)','rgb(218, 132, 218)', 'rgb(179, 177, 177)','rgb(33, 211, 175)','rgb(235, 187, 187)','#079494','rgb(181, 145, 218)','rgb(170, 123, 146)','rgb(252, 169, 87)','#eb6750',' #f0d39d','#2a2a80','#d5d5f7','rgb(228, 240, 66)','rgb(218, 132, 218)','rgb(179, 177, 177)','rgb(33, 211, 175)','rgb(235, 187, 187)',' #079494','rgb(181, 145, 218)','rgb(170, 123, 146)','rgb(252, 169, 87)',' #eb6750','#f0d39d','#2a2a80','#d5d5f7','rgb(228, 240, 66)','rgb(218, 132, 218)'];
//define the right button index for each level
let chooseNum = [null,3,7,10,19,31,6,30,6,28,1,4,50,102,120,225,220,150,35,55,100,10,88,220,55,130,200,99,100,200,350];
...
createButton = function createButton(numberSquare,className){
    ...
    document.getElementById(chooseNum[className]).style.backgroundColor=colorList[className];
}
...
function countdown(){
    ...
    if(s.innerHTML == 0){
       ...
       // if(className<=5)
           document.getElementById("result_color").innerHTML="You have finished "+className+" levels! <br>Out of 30 levels!";
